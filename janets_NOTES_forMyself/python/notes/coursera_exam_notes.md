...
https://www.coursera.org/learn/python-genomics/supplement/D1ztz/final-exam-instructions
...
While developing your program(s), please use the following example file to test your work:  `dna.example.fasta`  You'll be given a different input file to launch the exam itself.
...
# notes
To check my work on ORF finding:
```
cd ~/FH_fast_storage/git_more_repos/MalikLab_bioinformaticsResources/janets_NOTES_forMyself/python
module load EMBOSS/6.6.0-foss-2018b
getorf -noreverse -find 1 -sequence dna.example.fasta -outseq dna.example.getorf.fasta
```