...
public class ClickMe extends JComponent
    ...
    private Color spotColor = new Color(127,0,127) ; //purple
    ...
    public void paintComponent(Graphics g) {
        ...
        if (spot != null) {
            ...
            int squarehalfsize = spot.getSize();
            //squarehalfsize /= 2;
            g2d.setColor(spotColor);
           // g2d.fillOval(spot.x - radius, spot.y - radius,
           //              radius * 2, radius * 2);
            //g2d.fillRect(spot.x - squarehalfsize, spot.y - squarehalfsize,
            //             squarehalfsize * 2, squarehalfsize * 2);
            g2d.drawString("Janet", spot.x, spot.y);
