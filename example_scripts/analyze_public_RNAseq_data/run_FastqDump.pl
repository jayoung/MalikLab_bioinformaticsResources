...
if ($use_sbatch eq "createSbatchScript") {
    ...
    ## xxx SRAFILE will be put in a different location. For Pravrutha it is in e.g. ./SRR34066/SRR34066.sra (we use module load and maybe her env is different)
    ## xxx look at env when using module, look at my env
    ...
    print OUT "fastq-dump --split-spot --split-3 $gzipOption \${SRAFILE}\n";
    close OUT;
