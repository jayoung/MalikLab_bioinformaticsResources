...
Occasionally, we have large files that we want to be visible to people from outside the Hutch: the `/fh/fast/malik_h/pub` allows us to do that. Example - I have made custom UCSC tracks/hubs and put them in this folder, using URLs that look something like this: http://xfiles.fhcrc.org:7007/malik_h/pub/myHub3/
